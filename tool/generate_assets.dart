...
void main() {
  ...
  // Plus sign
  fillRect(icon, x1: 700, y1: 450, x2: 900, y2: 550, color: secondaryColor); // Horizontal
  fillRect(icon, x1: 750, y1: 350, x2: 850, y2: 650, color: secondaryColor); // Vertical
  ...
  print('Generated assets/icons/app_icon.png');
  ...
  fillRect(foreground, x1: 700, y1: 450, x2: 900, y2: 550, color: secondaryColor);
  fillRect(foreground, x1: 750, y1: 350, x2: 850, y2: 650, color: secondaryColor);

  File('assets/icons/app_icon_foreground.png')
    ..createSync(recursive: true)
    ..writeAsBytesSync(encodePng(foreground));
    
  print('Generated assets/icons/app_icon_foreground.png');
  ...
  print('Generated assets/images/logo_icon_only.png');
  ...
  print('Generated assets/images/logo_en.png');
  ...
  print('Generated assets/images/logo_ar.png');
  ...
  print('Generated assets/images/splash_bg.png');
