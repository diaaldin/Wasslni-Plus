...
abstract class S {
  ...
  /// No description provided for @performance_reports.
  ///
  /// In en, this message translates to:
  /// **'Performance Reports'**
  ...
  /// No description provided for @avg_delivery_time.
  ///
  /// In en, this message translates to:
  /// **'Avg. Delivery Time'**
  String get avg_delivery_time;

  /// No description provided for @cancel_rate.
  ///
  /// In en, this message translates to:
  /// **'Cancellation Rate'**
  String get cancel_rate;

  /// No description provided for @total_delivered.
  ///
  /// In en, this message translates to:
  /// **'Total Delivered'**
  String get total_delivered;

  /// No description provided for @total_assignments.
  ///
  /// In en, this message translates to:
  /// **'Total Assignments'**
  String get total_assignments;

  /// No description provided for @courier_performance.
  ///
  /// In en, this message translates to:
  /// **'Courier Performance'**
  ...
  /// No description provided for @privacy_policy_accepted.
  ///
  /// In en, this message translates to:
  /// **'Privacy policy accepted successfully'**
  String get privacy_policy_accepted;

  /// No description provided for @decline_privacy_policy.
  ///
  /// In en, this message translates to:
  /// **'Decline Privacy Policy'**
  String get decline_privacy_policy;

  /// No description provided for @decline_privacy_policy_message.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @scroll_to_read_all.
  ///
  /// In en, this message translates to:
